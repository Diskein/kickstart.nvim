...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sm', builtin.git_status, { desc = '[S]earch among modified files' })
    ...
    dependencies = {
      -- Snippet Engine
      {
        ...
        dependencies = {
          ...
          --       include = { 'cpp', 'c', 'python', 'shell', 'rust' },
          --     }
          --   end,
          -- },
        },
  ...
  { 'EdenEast/nightfox.nvim' },
  {
    ...
    keys = {
      ...
      { '<leader>sj', '<cmd>FzfLua lsp_finder<cr>', desc = 'Fzf ALL Lsp' },
    },
  },
}, {
  ui = {
